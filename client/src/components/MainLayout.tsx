  ...
  return (
    <div className='min-h-screen bg-background text-foreground selection:bg-primary/30 font-sans relative overflow-x-hidden'>
      ...
      <div className='fixed inset-0 z-0 pointer-events-none'>
        ...
        <div
          className='absolute bottom-[-10%] right-[-10%] w-[40%] h-[40%] bg-accent/20 rounded-full blur-[120px] opacity-20 animate-pulse-slow'
        ...
        <div className='max-w-7xl mx-auto flex justify-between items-center'>
          <Link to='/' className='flex items-center space-x-3 cursor-pointer group'>
            ...
            <div className='flex flex-col'>
              <span className='text-xl font-display font-bold tracking-tight leading-none group-hover:text-primary transition-colors'>
                FormCheck
              </span>
          ...
          <div className='flex items-center space-x-1 bg-white/5 rounded-full p-1 border border-white/5 backdrop-blur-md'>
            <Link
              ...
              onMouseEnter={() => import('../components/HomeView')}
            >
              Exercises
            </Link>
            <Link
              ...
              onMouseEnter={() => import('../components/Dashboard')}
            >
              Dashboard
            </Link>
          </div>
